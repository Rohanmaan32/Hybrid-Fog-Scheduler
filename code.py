...
def proposed_task_scheduling(task_list, fog_nodes, cloud_nodes, num_tasks, num_fog_nodes, num_cloud_nodes):
    total_makespan_sum, total_energy_consumption_sum, total_processing_cost_sum, total_fitness_value_sum = 0, 0, 0, 0
    ...
    print("\n*************Final Results (Proposed Scheduling)*************")
    print(f"Makespan: {total_makespan_sum / 1000.0 / NUMBER_OF_RUNS}")
    print(f"Energy Consumption: {total_energy_consumption_sum / NUMBER_OF_RUNS}")
    print(f"Processing Cost: {total_processing_cost_sum / NUMBER_OF_RUNS}")
    print(f"Fitness Value: {total_fitness_value_sum / NUMBER_OF_RUNS}")
...
def ga_proposed_task_scheduling(task_list, fog_nodes, cloud_nodes, num_tasks, num_fog_nodes, num_cloud_nodes):
    total_makespan_sum, total_energy_consumption_sum, total_processing_cost_sum, total_fitness_value_sum = 0, 0, 0, 0
    mutation_rate = 0.05
    population_size = 150
    num_iterations = 1000
    ...
    while True:
        ...
        while True:
            ...
            if choice_code == 1:
                ...
                proposed_task_scheduling(tasks_list, fog_nodes, cloud_nodes, num_tasks, num_fog_nodes, num_cloud_nodes)
            elif choice_code == 5:
                tasks_list = create_tasks(num_tasks)
                fog_nodes, cloud_nodes = create_nodes(num_fog_nodes, num_cloud_nodes)
            elif choice_code == 6:
                ...
                ga_proposed_task_scheduling(tasks_list, fog_nodes, cloud_nodes, num_tasks, num_fog_nodes, num_cloud_nodes)
            elif choice_code == 8:
